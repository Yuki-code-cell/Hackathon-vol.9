...
import { getQuestions } from '../../../apis/questions/index';
type TProps = {
  flowId: string | undefined;
};
export const EditQuestions = ({ flowId }: TProps) => {
  const { data: questionsData, isLoading } = useQuery('FormQuestions', () =>
    getQuestions({ flowId: flowId as string })
  );
  const {
    questions,
    addQuestions,
